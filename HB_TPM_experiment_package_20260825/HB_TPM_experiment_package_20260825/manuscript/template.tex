...
\author[ucla]{Elvis Han Cui}
\ead{elviscuihan@g.ucla.edu}
\ead[url]{https://orcid.org/0000-0001-9030-3141}

\author[zju]{Bingbin Li}
\ead{bingbin\_lee@zju.edu.cn}

\author[westlake]{Xin-Ya Zhang}
\ead{xinyazhang08@gmail.com}

\author[zhejianglab]{Yanan Li}
\ead{liyn@zhejianglab.com}

\author[ucla]{Weng Kee Wong}
\ead{wkwong@g.ucla.edu}

\author[zju]{Donghui Wang\corref{cor1}}
\ead{dhwang@zju.edu.cn}

\cortext[cor1]{Corresponding author.}

\affiliation[ucla]{
	organization={Department of Biostatistics, University of California, Los Angeles},
	city={Los Angeles},
	postcode={90024},
	state={CA},
	country={USA}
...
\affiliation[zju]{
	organization={Department of Computer Science, Zhejiang University},
	city={Hangzhou},
	country={China}
}

\affiliation[westlake]{
	organization={Center for Interdisciplinary Studies, Westlake University},
	city={Hangzhou},
	country={China}
}

\affiliation[zhejianglab]{
...
\begin{keyword}
Principal manifold \sep few-shot learning \sep data augmentation \sep hierarchical Bayesian transfer \sep trajectory modeling \sep latent support estimation
\end{keyword}
